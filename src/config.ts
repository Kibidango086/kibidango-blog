...
export const rssFeeds: { name: string; url: string }[] = [
  {
    name: "TG 频道",
    url: "https://srr.kibidango.top/telegram/channel/kibidango086_dynamic",
  },
];
...
export const social = {
  ...
  telegram: "https://telegram.me/kibidango086",
...
export const socialLinks: {
  ...
  { key: "facebook", label: "Facebook", url: social.facebook },
  {
    ...
    encrypted: encryptEmail(social.email),
  },
];
...
export const features = [
  { icon: "smart_toy", title: "AI", desc: "滥用 AI 的废物" },
  {
    icon: "music_note",
    title: "B站音乐播放器",
    desc: "BLBL Music Player — 桌面端 B 站音乐播放器，Electron + React + TS",
  },
  {
    icon: "build",
    title: "小工具",
    desc: "PPT 翻页器、视频水印制作器等多种小工具",
  },
  {
    icon: "smart_display",
    title: "B站 UP 主",
    desc: "7 个视频，最高 3.5 万播放",
  },
  { icon: "sports_esports", title: "柚子厨", desc: "Ciallo～(∠・ω< )⌒★" },
  {
    icon: "shield_lock",
    title: "隐私 & 自托管",
    desc: "自建 blog、工具站、AI agent、CDN",
  },
];
